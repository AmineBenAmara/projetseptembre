...
eleve::eleve()
{
    id=0; nom=" "; prenom=" "; sexe=" "; age=0; ; classe=" "; // constructeur par defaut aaaaaaaaaaaaa
}



eleve::eleve(int id,QString nom,QString prenom,QString sexe,int age,QString classe)//constructeur parametrer
{
    this->id=id;
    this->nom=nom;
    this->prenom=prenom;
